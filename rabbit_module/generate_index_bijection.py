...
if __name__ == "__main__":
    ...
    for i, inputBatch in enumerate(train_data_itrs):
        ...
        if i % 1024 == 0:
            tmp = time_wrap()
            print("batch:",i,"finish ratio:",round(i/total_batch_num,4),"time:",tmp-start)
    ...
    # =================================== store tmp_file ================================
    # output_file = "tmp_file/" + dataset + "_edge_" + str(table_idx) + "_new.pt"
    ...
    # [49999999, 38372, 17051, 7425, 20266, 4, 7040, 1522, 64, 49999999, 2953986, 397019, 11, 2209, 11797, 128, 4, 977, 15, 49999999, 38415840, 49999999, 578540, 12787, 109, 37
